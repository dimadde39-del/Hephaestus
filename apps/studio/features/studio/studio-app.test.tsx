...
function providerConfig(overrides: Partial<StudioProviderConfig>): StudioProviderConfig {
  return {
    ...
    thinking_enabled: overrides.thinking_enabled ?? false,
    reasoning_effort: overrides.reasoning_effort ?? "high",
    max_output_tokens: overrides.max_output_tokens ?? 4096,
    effective_source: overrides.effective_source ?? "studio",
    api_key_source: overrides.api_key_source ?? "Studio database",
