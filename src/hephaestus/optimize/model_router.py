...
def route_model(request: ModelRouteRequest) -> ModelRoute:
    ...
    candidates: list[tuple[float, float, ModelProfile]] = []
    ...
    for profile in request.profiles:
        ...
        candidates.append((cost, -quality, profile))
    ...
    cost, negative_quality, selected = sorted(candidates, key=lambda item: item[:2])[0]
